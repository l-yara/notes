* Currents
- Вадим Шимбаев: 20 Manor Street, Gillingham, Brompton, ME7 5AW Kent
  :::: current:
...
- Coursera: А лекции Воронцова лучше слушать не в курсе, на на страничке ШАД (https://yandexdataschool.ru/edu-process/courses). Там они не обескровлены попытками впихнуть их в формат курсеры. Первый курс «Математика и Python для анализа данных» специализации «Машинное обучение и анализ данных Specialization» (https://www.coursera.org/specializations/mashinnoye-obucheniye) тоже пока не радует глубиной изложения.
